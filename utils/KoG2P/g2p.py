...
def checkCharType(var_list):
    ...
    for i in range(len(var_list)):
        if var_list[i] == 32:   # whitespace
            ...
            checked.append(0)
        elif var_list[i] > 32 and var_list[i] < 128 :
            checked.append(2)
...
def graph2phone(graphs):
    ...
    while iElement < len(integers):
        ...
        '''
            ...
            if integers[iElement] == 33:
                #phones = phones + PON[0]
                ponlist.append(PON[0])
            #elif integers[iElement] == 44:
            #    ponlist.append(PON[1])
            #    phones = phones + PON[1]
            #elif integers[iElement] == 46:
            #    phones = phones + PON[2]
            elif integers[iElement] == 63:
                ponlist.append(PON[3])
                #phones = phones + PON[3]
        '''
...
def graph2prono(graphs, rule_in, rule_out):
    ...
    #print(graphs)
    #print(graph2phone(graphs))
    romanized = graph2phone(graphs)
    #romanized,ponlist = graph2phone(graphs)
...
def runG2P(filename,rulebook):
    f = open(filename,'r')
    for i in f.readlines():
        data = i.strip('\n')
        runKoG2P(data,'rulebook.txt')
